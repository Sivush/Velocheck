...
/**
 * Created by lasyd on 10/20/2016.
 */

//для выноса базы из рута
...
public class DataBaseUtil {
    ...
    final static String DATABASE_NAME = "velocheck.db";

    //example WhatsApp :  /data/data/com.whatsapp/databases/msgstore.db
    final static String FOLDER_EXTERNAL_DIRECTORY = getExternalStorageDirectory() + "/documents";
